...
(function(){
	...
	worktime.y2014 = { "d0101": 2, "d0126": 1, "d0131": 2, "d0201": 2, "d0202": 2, "d0203": 2, "d0204": 2, "d0205": 2, "d0206": 2, "d0208": 1, "d0405": 2, "d0406": 2, "d0407": 2, "d0501": 2, "d0502": 2, "d0503": 2, "d0504": 1, "d0602": 2, "d0908": 2, "d0928": 1, "d1001": 2, "d1002": 2, "d1003": 2, "d1004": 2, "d1005": 2, "d1006": 2, "d1007": 2, "d1011": 1 };
	
	//公历法定节假日
	var solarHolidaysFestival = {
		'd0101': '元旦',
		'd0501': '劳动节',
		'd1001':'国庆节'
	}
	...
	*/
	...
	function solarToLunar(_year,_month,_day){
		...
		if(lunarDate[1] == lunarMonthDays.length-1 && lunarDate[2]==lunarMonthDays[lunarMonthDays.length-1]){
			...
			lunarHoliday = lunarHolidayFestival[formateDayD4(lunarDate[1] - 1, lunarDate[2])];
		}else{
			lunarFtv = lunarFestival[formateDayD4(lunarDate[1], lunarDate[2])];
			lunarHoliday = lunarHolidayFestival[formateDayD4(lunarDate[1], lunarDate[2])];
		}
		...
		var res = {
			...
			solarHolidays: solarHolidaysFestival[formateDayD4(month, day)],
			lunarHolidays:lunarHoliday
		};
	...
	function weekendFromate(year, month, day) {
		var weekend = getWeekend(year, month, day);
		var weekendstr = "";
		switch (weekend) {
			case 0: weekendstr = "星期天"; break;
	...
	var LunarCalendar = {
		...
		formateDayD4: formateDayD4,
		getWeekend: getWeekend,
		weekendFromate: weekendFromate
	};
